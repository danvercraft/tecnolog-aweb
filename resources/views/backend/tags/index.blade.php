    ...
    <div class="card shadow mb-4">
            ...
            <div class="ml-auto">
                @can('create_tag')
                    ...
                    <span class="icon text-white-50">
                        ...
                        <span class="text">Nuevo Establecimiento</span>
                    </a>
                @endcan
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tr>
                    <th>Nombre</th>
                    <th>Conciertos Realizados</th>
                    <th>Estado</th>
                    <th>Creado el</th>
                    <th class="text-center" style="width: 30px;">Acción</th>
                </tr>
                </thead>
                <tbody>
                @forelse($tags as $tag)
                ...
                @empty
                    <tr>
                        <td class="text-center" colspan="6">No hay establecimientos</td>
                    </tr>
                @endforelse
                </tbody>
                <tfoot>
