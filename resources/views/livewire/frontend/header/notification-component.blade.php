                ...
                <a class="dropdown-item d-flex align-items-center" wire:click="markAsRead('{{ $notification->id }}')">
                    <div>
                        ...
                        <span class="font-weight-bold">
                            Compra #{{ $notification->data['order_ref'] }} completada exitosamente
                        </span>
                    </div>
                </a>
            @endif
            @if ($notification->type == 'App\Notifications\Frontend\User\OrderStatusNotification')
                <a class="dropdown-item d-flex align-items-center" wire:click="markAsRead('{{ $notification->id }}')">
                    <div>
                        ...
                        <span class="font-weight-bold text-secondary">Compra #{{ $notification->data['order_ref'] }}</span>
                        <span class="badge badge-danger">{{ $notification->data['last_transaction'] }}</span>
                    </div>
                </a>
            @endif
        @empty
            <div class="dropdown-item text-center">No hay notificaciones!</div>
        @endforelse
    </div>
</div>
